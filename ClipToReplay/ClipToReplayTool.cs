...
public class ClipToReplayTool : ITool, IHasOutput<BinFile>, IConfigurable<ClipToReplayConfig>
{
    ...
    private static readonly byte[] headerPart1 = [71, 66, 88, 6, 0, 66, 85];
    private static readonly byte[] headerPart2 = [82, 0, 48, 9, 3];
    private static readonly byte[] headerPart3 = [69, 0, 0, 0, 0, 0, 0, 0];
